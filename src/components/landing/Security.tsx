...
function ComplianceBadge({ label, sublabel, variant }: { label: string; sublabel: string; variant: 'blue' | 'teal' | 'green' | 'accent' }) {
  ...
  return (
    <div className={`w-20 h-20 md:w-24 md:h-24 rounded-full border-2 ${colors[variant]} bg-card/80 flex flex-col items-center justify-center shadow-sm backdrop-blur-sm`}>
      ...
      <span className="text-[8px] md:text-[9px] font-medium text-muted-foreground uppercase tracking-wider">
        {variant === 'blue' ? 'TYPE 1' : variant === 'teal' ? 'CERTIFIED' : ''}
      </span>
    </div>
  );
}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto glass-panel p-10 md:p-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            ...
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-primary/30 bg-card/80 flex flex-col items-center justify-center shadow-sm backdrop-blur-sm">
            ...
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-accent/30 bg-card/80 flex flex-col items-center justify-center shadow-sm backdrop-blur-sm">
